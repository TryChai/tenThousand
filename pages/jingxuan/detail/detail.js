...
let app = getApp(), id = 0,openid,type=1;
            ...
            // console.log(res.data);
             that.setData({
              ...
              console.log(that.data.detail);
                typeof that.data.detail!='undefined'&&that.data.detail.content!= null && that.data.detail.content != 'undefined' ? WxParse.wxParse('insertData', 'html', res.data.detail.content, that,10) :'';
           }
          }
       })
